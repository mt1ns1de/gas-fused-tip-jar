// app/layout.tsx
import "./globals.css";
import BaseCursorAura from "./components/BaseCursorAura";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ru">
      <body className="min-h-screen bg-baseBg text-white antialiased">
        {/* Аура курсора (уважает prefers-reduced-motion внутри компонента) */}
        <BaseCursorAura />

        <div className="mx-auto max-w-3xl px-4 py-8 relative z-[50]">
