...
export default function TipSuccessModal({
  ...
  // Состояние для управления рендерингом (чтобы совсем убирать из DOM после анимации, если нужно)
  // Но для простоты и плавности используем CSS opacity
          ...
          <div className="flex gap-3">
            {explorerTx && (
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="flex-1 flex items-center justify-center gap-1.5 rounded-lg bg-white/5 px-3 py-2.5 text-center text-xs font-medium text-neutral-300 hover:bg-white/10 transition-colors border border-white/5"
              >
                View Transaction
